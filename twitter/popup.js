...
function updflags(){
  //alert("hi");
  chrome.runtime.sendMessage({type:"flagupdate",data:{timel:hidtimelchk.checked,notif:hidnotifchk.checked,trend:hidtrendchk.checked,whofl:hidwhotfchk.checked,right:hidrisidchk.checked}});
